...
export const EMERGENCY_SERVICE_AREAS = [
  ...
  },
  {
    ...
    responseMinutes: 90,
    emergencyPath: '/emergency-tyre-fitting/aberdeen/city-centre',
    punctureRepairPath: '/puncture-repair/aberdeen/city-centre',
  },
  {
    citySlug: 'inverness',
    cityName: 'Inverness',
    ...
    postcode: 'IV1',
    county: 'Highland',
    landmark: 'Inverness Castle',
    responseMinutes: 100,
    emergencyPath: '/emergency-tyre-fitting/inverness/city-centre',
    punctureRepairPath: '/puncture-repair/inverness/city-centre',
  },
  {
    citySlug: 'perth',
    cityName: 'Perth',
    ...
    landmark: 'Perth Concert Hall',
    responseMinutes: 70,
    emergencyPath: '/emergency-tyre-fitting/perth/city-centre',
    punctureRepairPath: '/puncture-repair/perth/city-centre',
  },
  {
    citySlug: 'dundee',
    cityName: 'Dundee',
    ...
    landmark: 'V&A Dundee',
    responseMinutes: 65,
    emergencyPath: '/emergency-tyre-fitting/dundee/waterfront',
    punctureRepairPath: '/puncture-repair/dundee/waterfront',
  },
