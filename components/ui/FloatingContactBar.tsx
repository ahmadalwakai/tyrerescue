...
// Inline SVG icons (Lucide-style) to avoid extra dependency
function PhoneIcon() {
  return (
    ...
    >
      ...
      >
        ...
        <ChakraLink
          ...
          style={{
            fontFamily: 'var(--font-body)',
            animation: 'floatingWaPulse 3s ease-in-out infinite',
          }}
        >
          <WhatsAppIcon />
          WhatsApp
      ...
      {/* Mobile: two stacked circle buttons */}
      <Flex
      ...
      >
        <ChakraLink
          ...
          aria-label="WhatsApp us"
          style={{ animation: 'floatingWaPulse 3s ease-in-out infinite' }}
        >
          <WhatsAppIcon />
        </ChakraLink>
        <ChakraLink
